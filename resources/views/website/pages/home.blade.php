    ...
    <div class="site-section site-blocks-2">
        <div class="container">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                ...
                <figure class="image">
                    <img src="{{asset('assets/images/women12.jpg')}}" alt="" class="img-fluid">
                </figure>
                <div class="text">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                <a class="block-2-item" href="#">
                <figure class="image">
                    <img src="{{asset('assets/images/children1.jpg')}}" alt="" class="img-fluid">
                </figure>
                <div class="text">
                    <span class="text-uppercase">{{ __('home.collections') }}</span>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                <a class="block-2-item" href="#">
                <figure class="image">
                    <img src="{{asset('assets/images/men1.jpg')}}" alt="" class="img-fluid">
                </figure>
                <div class="text">
                    <span class="text-uppercase">{{ __('home.collections') }}</span>
                    <h3>{{__('home.Men')}} </h3>
